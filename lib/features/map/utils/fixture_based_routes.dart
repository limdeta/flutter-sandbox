...
class FixtureBasedRoutes {
  static final IRouteRepository _routeRepository = GetIt.instance<IRouteRepository>();
  ...
  static Future<List<MapDisplayRoute>> getRoutesForSalesRep(User salesRep) async {
    try {
      final userRoutes = await _routeRepository.watchUserRoutes(salesRep).first;
