...
class Route {
  ...
  final List<IPointOfInterest> pointsOfInterest;
  ...
  Route copyWith({
    ...
    DateTime? startTime,
    DateTime? endTime,
    List<IPointOfInterest>? pointsOfInterest,
    List<LatLng>? path,
    RouteStatus? status,
  }) {
    return Route(
  ...
  List<IPointOfInterest> get clientPoints {
  ...
  IPointOfInterest? get currentPoint {
  ...
  IPointOfInterest? getPointAtTime(DateTime time) {
    IPointOfInterest? closest;
  ...
  List<IPointOfInterest> get uncompletedPoints {
  ...
  List<IPointOfInterest> get priorityUncompletedPoints {
