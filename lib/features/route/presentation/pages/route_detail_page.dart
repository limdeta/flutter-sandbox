...
class RouteDetailPage extends StatelessWidget {
  ...
  Widget _buildPointCard(IPointOfInterest point, int index) {
    return Card(
  ...
  Widget _buildTimeInfo(IPointOfInterest point) {
    return Column(
      children: [
        Row(
          children: [
  ...
  IconData _getPointTypeIcon(IPointOfInterest point) {
  ...
  String _getPointTypeText(IPointOfInterest point) {
    if (point is TradingPointOfInterest) {
